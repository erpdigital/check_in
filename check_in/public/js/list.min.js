(function () {
	...
	frappe.views.ImageView = class ImageView extends frappe.views.ListView {
		...
		item_details_html(item) {
			...
			var info_html = "<div class=hello><ul class=\"list-unstyled image-view-info\">";
			var set = false;
			info_html += "<li>" +item.name + "</li>";
			info_html += "<li>" +item.designation + "</li>";
			info_html += "</ul></div>";
			return info_html;
		}
		...
		item_html(item) {
			...
			var indic ='';
			(item.online == 'Online')? indic= "<p class=\"indicator-pill green\" style=\"z-index:1; position:absolute;\" ></p>" : indic= "<p class=\"indicator-pill red\" style=\"z-index:1; position:absolute;\"></p>" 
